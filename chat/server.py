...
CONTACT_TO = os.environ.get("ABAU_CONTACT_TO", "e.pfeiffer@a-bau.de")
CONTACT_FROM = SMTP["user"] or "mail@nexifyai.cloud"
RESEND_KEY = _secret({"RESEND_API_KEY"})
RESEND_FROM = "A-Bau Meisterbetrieb <kontakt@nexifyai.cloud>"  # R84 Interim: a-bau.info noch nicht in Resend verifiziert (403 sonst); auf e.pfeiffer@a-bau.de umstellen, sobald Domain verifiziert (Resend-DNS in CF-Zone a-bau.de, Token noetig)
...
- Telefon: +49 2166 9925056, E-Mail: e.pfeiffer@a-bau.de
