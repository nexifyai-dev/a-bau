...
| Datenumfang A-Bau | Nur Formular-Felder (Name, E-Mail, Telefon, Nachricht) für Einzel-Versand an kontakt@a-bau.info; keine Liste/Kampagnen | Implementierung chat/server.py (R52) |
